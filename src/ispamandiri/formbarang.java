...
public class formbarang extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(tidbarang, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 100, 230, 30));
        ...
        jLabel1.setText("Form Pengelolaan Barang");
    ...
    private void beditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_beditActionPerformed
        // TODO add your handling code here:
        if(tidbarang.getText().equals("") ||tnamabarang.getText().equals("") || tjumlahbarang.getText().equals("")|| thargabeli.getText().equals("")|| thargajual.getText().equals("")){
            ...
            try {
                Connection c = koneksi.getKoneksi();
                String sql = "UPDATE  tbl_barang SET nama_barang =  '" + tnamabarang.getText() + "', jumlah='"+ tjumlahbarang.getText() + "', harga_beli='"+ thargabeli.getText() + "', harga_jual='"+ thargajual.getText() + "' WHERE  id_barang ='" + tidbarang.getText() + "'";
    ...
    private void bhapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bhapusActionPerformed
        // TODO add your handling code here:
        try {
            String sql ="delete from tbl_barang where id_barang='"+tidbarang.getText()+"'";
